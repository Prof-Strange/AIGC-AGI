...
\title{Without Machine-Aided Proofs, Modern Pure (Noninterdisciplinary) Mathematics is a Private Language of a Dissociative Meta-Subject: A Wittgensteinian Critique}
\author{J.L.}
...
\begin{itemize}
    ...
    \item \emph{Rebuttal:} Errors are found only when the complexity is within the cognitive grasp of the alters. As complexity exceeds human limits (without machine aid), the capacity for error-checking dissolves into communal faith.
\end{itemize}
